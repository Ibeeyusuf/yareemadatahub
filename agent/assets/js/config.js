...
if (typeof API_CONFIG === "undefined") {
  var API_CONFIG = {
    BASE_URL: "https://api.yareemadatahub.com/api/v1",
...
if (typeof API === "undefined") {
  var API = {
    ...
    removeToken() {
      ...
      try {
        const d = JSON.parse(
          localStorage.getItem(API_CONFIG.STORAGE_KEYS.AGENT_DATA) || "{}",
        );
        const safe = { _id: d._id, id: d.id, pin: d.pin };
        localStorage.setItem(
          API_CONFIG.STORAGE_KEYS.AGENT_DATA,
          JSON.stringify(safe),
        );
      } catch (e) {}
    },
