class YareemaAPI {
  constructor() {
    this.baseURL = API_CONFIG?.BASE_URL || "https://api.yareemadatahub.com";
  ...
  async getAgents(params = {}) {
    ...
    return await this.request(
      `/api/v1/agents/agents${queryString ? "?" + queryString : ""}`,
    );
  }
  ...
  async verifyAgentDocuments(agentId, documentType, status, remarks) {
    return await this.request(
      `/api/v1/agents/agents/${agentId}/verify-documents`,
      {
        method: "POST",
  ...
  async getAgentPerformance(agentId, period = "monthly") {
    return await this.request(
      `/api/v1/agents/agents/${agentId}/performance?period=${period}`,
    );
  }
  ...
  async getAgentCommissionReport(agentId, params = {}) {
    ...
    return await this.request(
      `/api/v1/agents/agents/${agentId}/commission-report${queryString ? "?" + queryString : ""}`,
    );
  }

  async processCommissionWithdrawal(agentId, amount, paymentMethod, reference) {
    return await this.request(
      `/api/v1/agents/agents/${agentId}/withdraw-commission`,
      {
        method: "POST",
  ...
  async getPendingAgents(params = {}) {
    ...
    return await this.request(
      `/api/v1/admin/pending-agents${queryString ? "?" + queryString : ""}`,
    );
  }
  ...
  async getServicePricing(params = {}) {
    ...
    return await this.request(
      `/api/v1/admin/pricing${queryString ? "?" + queryString : ""}`,
    );
  }
  ...
  async getProviders(params = {}) {
    ...
    return await this.request(
      `/api/v1/admin/providers${queryString ? "?" + queryString : ""}`,
    );
  }

  async updateProviderStatus(providerName, statusData) {
    return await this.request(
      `/api/v1/admin/providers/${providerName}/status`,
      {
        method: "PUT",
        body: statusData,
      },
  ...
  async getAdminLogs(params = {}) {
    ...
    return await this.request(
      `/api/v1/admin/logs${queryString ? "?" + queryString : ""}`,
    );
  }
  ...
  async consoleGetLogs(page = 1, limit = 50) {
    return await this.request(
      `/api/v1/console/logs?page=${page}&limit=${limit}`,
    );
  }
  ...
  async consoleUpdateMarkup(providerId, serviceType, percentage) {
    return await this.request(
      `/api/v1/console/providers/${providerId}/markups`,
      {
        method: "PUT",
